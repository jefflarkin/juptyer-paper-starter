...
pdf: ${DOCNAME}.ipynb
	jupyter nbconvert --template article_nocode.tplx --to pdf ${DOCNAME}.ipynb --execute
tex: ${DOCNAME}.ipynb
	jupyter nbconvert --template article_nocode.tplx --to latex ${DOCNAME}.ipynb --execute
.PHONY: clean
clean:
